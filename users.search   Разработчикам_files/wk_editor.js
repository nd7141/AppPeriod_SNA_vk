...
extend(WkEditor.prototype, {
  ...
  insertVideo: function(thumb, name, duration, link, videoId) {
    ...
    this.getImgSize(thumb, (function(w, h) {
      ...
      var videoEl = se('<a class="wk_video" href="'+link+'" contentEditable="false" onclick="return showVideo(\''+videoId+'\', \'\', {autoplay: 1}, event)"><img alt="'+name+'" title="'+name+'" src="/images/play_video.png?3" style="background: url('+thumb+') no-repeat;">');
      this.insert([videoEl]);
