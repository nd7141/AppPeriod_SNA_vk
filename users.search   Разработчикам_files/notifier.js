...
Notifier = {
  ...
  initFrameTransport: function () {
    ...
    curNotifier.post_message = Notifier.debug || !(browser.opera && intval(browser.version) < 15 || browser.msie || browser.mozilla && majorVersion >= 31 || browser.safari && majorVersion >= 7 && minorVersion >= 1);
